...
public class SavegameController {
    ...
    public ResponseEntity deleteAllSavegamesForGameservice(@PathVariable String gameservice, Principal principal, @RequestParam("access_token") String token) {
        ...
        if (!callerRole.equals("[ROLE_ADMIN]")) {
            if (!tokenController.nameFromToken(token).equals(gameServers.getRegistringServiceAccountForGame(gameservice)))
    ...
    public ResponseEntity registerSafegameForGameservice(@PathVariable String gameservice, @PathVariable String savegameid, @RequestBody Savegame savegame, Principal principal, @RequestParam("access_token") String token) {
        if (!tokenController.nameFromToken(token).equals(gameServers.getRegistringServiceAccountForGame(gameservice)))
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Savegames can only be deleted by the " +
    ...
    public ResponseEntity deleteSpecificSafegameForGameservice(@PathVariable String gameservice, @PathVariable String savegameid, Principal principal, @RequestParam("access_token") String token) {
