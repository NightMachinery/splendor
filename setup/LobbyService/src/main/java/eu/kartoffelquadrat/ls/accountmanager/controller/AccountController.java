...
public class AccountController {
  ...
  public ResponseEntity updatePassword(@PathVariable String name,
    ...
    String callerRole = tokenController.currentUserRole(token).toString();
      if (!callerRole.contains("ADMIN") && !tokenController.nameFromToken(token).equals(name)) {
          return ResponseEntity.status(HttpStatus.BAD_REQUEST)
  ...
  public ResponseEntity queryUserDetails(@PathVariable String name, Principal principal, @RequestParam("access_token") String token) {
